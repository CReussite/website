document.getElementById('footer-placeholder').outerHTML = `
  <footer>
    <div class="container">
      ...
      <p>Par <strong class="footer-author">Clara Renaud</strong>, polytechnicienne et docteure en sciences de la vie</p>
      <p class="mt-8">
        <a href="mailto:contact@creussite.fr">contact@creussite.fr</a>
        &nbsp;·&nbsp;
        <a href="#">Mentions légales</a>
      </p>
      <p class="mt-8 footer-credit">© 2026 Clara Renaud — Tous droits réservés</p>
    </div>
  </footer>
`;
